...
#print(python_exp)
#javasolt megoldás:
prof=(input("Wana be a pro pyhton developer? (YES/NO)")).upper()
answ= "want" if prof=="YES" else "don't want" #ez a jól látom case sensitive, lehet úgy csinálni, hogy ne legyen az?
