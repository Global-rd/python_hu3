...
prog_language_list = input("Privode your 4 favourite programming language. Seperate them by comma): ")
# Konvertáld a kapott stringet egy listává, és add hozzá a fenti dictionary-hez “skills” néven. 
user_info['skills'] = prog_language_list.split(",")
#print(user_info) #print(user_info["favourite_meals"]) selfcheck
...
user_info["phone_contacts"]["Bettina"] = "+36201234567"
#print(user_info["phone_contacts"]) selfcheck
...
user_info["phone_contacts"]["Antonio"] = ["+36204343434", "+36708787878"]
