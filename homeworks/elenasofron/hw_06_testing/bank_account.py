class BankAccount:
    ...
    def deposit(self, amount: float):
        try:
            ...
            self.balance += amount
        except TypeError: #hozzaadtam
            raise TypeError("Deposite must be a number") #hozzaadtam
    ...
    def transfer(self, amount: float, target_account: 'BankAccount'):
        if amount <= 0: #hozzaadtam
            raise ValueError ("Transfer amount must be positive.") #hozzaadtam
