...
while True:
    ...
    if gamer1=="p" and  gamer2 =="r": gamer1_win+=1
    elif gamer1=="r" and gamer2 =="s": gamer1_win+=1
    elif gamer1=="s" and gamer2 =="p": gamer1_win+=1
    elif gamer1==gamer2:continue
    else:gamer2_win+=1
