...
while True:
    ...
    if (max_rounds % 2 != 0) and (max_rounds > 2):
        break
    else:
        print("You need to enter an odd number which is more than one")
...
while act_round <= max_rounds:
    ...
    while True:
        gamer_A_answer = input("GAMER_A > Type in your answer: ").lower()
        if gamer_A_answer in ["rock", "paper", "scissors"]:
            break
        else:
            print("Please type in the words according to rule!")
    while True:
        gamer_B_answer = input("GAMER_B > Type in your answer: ").lower()
        if gamer_B_answer in ["rock", "paper", "scissors"]:
            if gamer_A_answer == gamer_B_answer:
                print("Same answer. Round again!")
                break
            elif (gamer_A_answer == "rock" and gamer_B_answer == "scissors") or (gamer_A_answer == "paper" and gamer_B_answer == "rock") or (gamer_A_answer == "scissors" and gamer_B_answer == "paper"):
                act_round += 1
                gamer_A_point += 1
                break
            else:
